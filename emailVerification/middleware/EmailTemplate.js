const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          <div class="header">Verify Your Email || Curious Community</div>
          <div class="content">
              <p>Hello,</p>
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} Curious Community. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
const Welcome_Email_Template = `
  ...
  <body>
      <div class="container">
          <div class="header">Welcome to Curious Community!</div>
          <div class="content">
